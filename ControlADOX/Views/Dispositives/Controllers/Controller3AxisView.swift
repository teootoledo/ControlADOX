...
struct Controller3AxisView: View {
...
struct Controller3AxisView_Previews: PreviewProvider {
    static var previews: some View {
        Controller3AxisView(dispositive: Dispositive(id: 1, name: "Nombre", description: "Descripción", color: .blue, banner: Image(""), ip: "192.168.0.205", port: 3489, control: 1, avatar: Image("user"), favorite: true)).previewLayout(.fixed(width: 400, height: 320))
    }
}
